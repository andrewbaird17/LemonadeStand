...
namespace LemonadeStandProject
{
    public static class UserInterface
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("Ahhhh... Its a hot lazy summer in your little subarb of the world and your eleven years old again.\n" +
                "You have five dollars left over from your birthday money, and your mom even gives you fifteen more. Your done\n" +
                "exploring the neighborhood with your friends and are excited by the prospect of earning some money! You decide\n" +
                "to open a lemonaid stand!\n\n" +
                "Lemonaid Stand is played over a minimum of seven days, your day will be as follows:\n" +
                ...
                "When you have open the store for the day, customers will begin to decide if they would like to purchase from you.\n" +
                "\n" +
